@extends('user.classify.sort-by-master')
    ...
    <div class="product__items ">
        <div class="product__items--thumbnail">
            <a class="product__items--link" href="{{route('home.product-detail', $value[0]['id'])}}">
                <img class="product__items--img product__primary--img" src="{{url('uploads/product')}}/{{$value[0]['image']}}" alt="product-img">
            </a>
        ...
        <div class="product__items--content">
            ...
            <div class="product__items--price">
                <span class="current__price">{{$value[0]['sale_price']}}đ</span>
                <span class="price__divided"></span>
                <span class="old__price">{{$value[0]['price']}}đ</span>
            </div>
