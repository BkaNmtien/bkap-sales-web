    ...
    <div class="product__items ">
        <div class="product__items--thumbnail">
            <a class="product__items--link" href="{{route('home.product-detail', $value['id'])}}">
                <img class="product__items--img product__primary--img" src="{{url('uploads/product')}}/{{$value['image']}}" alt="product-img">
            </a>
        ...
        <div class="product__items--content">
            <h3 class="product__items--content__title h4"><a href="{{route('home.product-detail', $value['id'])}}">{{$value['name']}}</a></h3>
            <div class="product__items--price">
                <span class="current__price">{{$value['sale_price']}}đ</span>
                <span class="price__divided"></span>
                <span class="old__price">{{$value['price']}}đ</span>
            </div>
